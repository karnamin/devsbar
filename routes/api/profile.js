...
// @route       request type: PUT, endpoint - api/profile/experience
...
router.put(
    ...
    async (req, res) => {
        ...
        try {
            ...
            profile.experience.unshift(newExp); // unshift so new exp are first in array
...
// @route       request type: DELETE, endpoint - api/profile/experience/:exp_id
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
    try {
        ...
        // remove the item to be deleted with splice
...
// @route       request type: PUT, endpoint - api/profile/education
...
router.put(
    ...
    async (req, res) => {
        ...
        try {
            ...
            profile.education.unshift(newEdu); // unshift so new exp are first in array
...
// @route       request type: DELETE, endpoint - api/profile/education/:edu_id
...
// @route       request type: GET, endpoint - api/profile/github/:username
// @desc        Get user repos from Github
// @access      Public
router.get('/github/:username', (req, res) => {
    try {
        // get repos of user - 5 per page sorted asc order
        const options = {
